...
(function () {
    ...
    // The website's own repo, so visitors can propose fixes to the site itself.
    var WEBSITE_REPO_URL = "https://github.com/mlcast-community/mlcast-website";
    ...
    var markup =
        ...
        "  </div>" +
        "</header>" +
        '<a class="improve-banner" href="' + WEBSITE_REPO_URL + '" target="_blank" rel="noreferrer" title="Suggest a website improvement on GitHub">' +
        '  <span class="material-symbols-outlined" aria-hidden="true">edit</span>' +
        '  <span class="improve-banner-label">Improve this site</span>' +
        "</a>" +
