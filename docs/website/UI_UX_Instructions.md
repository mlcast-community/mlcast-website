...
- The fixed `.improve-banner` pill sits under the header at the top right
  (viewport-anchored, z-40) and links to the website repo; it collapses to an
  icon-only circle below `768px` so it never crowds page headings.
